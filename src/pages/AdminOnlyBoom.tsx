...
export function AdminOnlyBoom() {
  ...
  const fetchEmails = async () => {
    try {
      ...
      const emailsData: Email[] = response.data;
      setEmails(emailsData);

      const uniqueDomains = Array.from(new Set(emailsData.map(email => email.temp_email.split('@')[1])));
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-gray-800 pt-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-1 bg-gray-800 rounded-lg p-4 h-[calc(100vh-16rem)] overflow-y-auto">
